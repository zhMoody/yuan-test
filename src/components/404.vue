  ...
  <section class="error">
    ...
    <div class="error__content">
      <div class="error__message message">
        <h1 class="message__title">找不到页面了呢～</h1>
      ...
      <div class="error__nav e-nav">
        <router-link class="e-nav__link" to="/"></router-link>
      </div>
    </div>
    <!-- END Content -->
...
.e-nav__link:before {
  content: '';
  height: 200px;
  background: linear-gradient(30deg, #212121, #ccc);
  position: absolute;
  top: 70px;
  right: 70px;
  width: 260px;
...
.light {
  width: 150px;
  height: 0px;
  border-bottom: 500px solid rgb(44 255 255 / 24%);
